...
const Services = () => {
  return (
    <div className="w-full relative my-5 mb-[7rem] mt-20 sm:mt-0">
      <div className="w-full relative sm:px-[7rem] px-7">
        <div className="absolute top-0 right-0">
          <img src={serviceStars} alt="cluster of stars" />
        </div>
        <div className="flex flex-col items-center">
          <p className="text-[#5E6282] font-[600] text-[18px] leading-[27px]">
            CATEGORY
          </p>
          <h2 className="text-[#14183E] font-[700] text-[30px] sm:text-[50px] leading-[64px] mb-12 volkhov">
